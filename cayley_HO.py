...
np.savetxt(filename,np.stack((wt,col5,col3),axis=1),header=f'w*t (2*pi)\trel err in unct (5)\trel err in unct (3)\nhb=m={m}\tV=1/2mw^2x^2\t sig = {sig}\tw={w}\tdx=dt={dx}\tx0={x0}\tp0={p0}',fmt="%e")
