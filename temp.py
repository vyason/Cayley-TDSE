...
for disc_type in ['tridiag','pentadiag']:
    ...
    while t < tmax:
        ...
        exp_psq = (-hb**2*simps(psi_st*diff2_5pt(psi,dx,J),dx=dx)).real
...
np.savetxt(f'errors_cayley_HO_dxdt{dx:.3f}.dat',np.stack((time,col5,col3),axis=1),header='w*t\trel err in unct (5)\trel err in unct (3)',fmt="%e")
